...
<div class="container">
    <div class="login__content">
        <img src="{{asset('assets/img/gym-login1.jpg')}}"  alt="login" class="login__img">
                ...
                <div class="login__inputs">
                    <div>
                        ...
                        <div class="input">
                            ...
                            <input  name="name" value="{{old('name')}}" type="text" placeholder="Enter your User Name" required class="input__password input__email" id="username">
                        </div>
                    </div>
                    {{-- Error name --}}
                    @error('name')
                    ...
                    <div>
                        ...
                        <div class="input">
                            ...
                            <input name="email" value="{{old('email')}}" type="email" placeholder="Enter your email address" required class="input__password input__email" id="email">
                        </div>
                    </div>
                    {{-- Error Email --}}
                    @error('email')
                    ...
                    <div>
                        ...
                        <div class="input">
                            ...
                            <input name="phone" value="{{ old('phone') }}" type="tel" placeholder="Enter your Phone number" required class="input__password input__email" id="phone">
                        </div>
                    </div>
                    {{-- Error phone --}}
                    @error('phone')
                    ...
                    <div>
                        ...
                        <div class="input">
                            ...
                            <input name="age" value="{{ old('age') }}" type="number" placeholder="Enter your Age" required class="input__password input__email" id="age">
                        </div>
                    </div>
                    {{-- Error Age --}}
                    @error('age')
                    ...
                    <div>
                        ...
                        <div class="input">
                            ...
                            <i class="bx bx-lock-alt input__lock"></i>
                            <input name="password_confirmation" type="password" placeholder="Re-Enter your password" required class="input__password" id="input-passs">
