...
<div class="container">
    <div class="login__content">
        ...
        <form action="{{route('nutrition',$id)}}" method="post" enctype="multipart/form-data" class="login__form">
            @csrf
                ...
                <div class="login__inputs">
                    ...
                    <div>
                        ...
                        <div class="input">
                            ...
                            <select  class="input__password input__email" name="allergy[]" multiple="multiple" id="Allergy">
                                <option >Milk</option>
                                <option >Eggs</option>
