...
<div class="container">
    <div class="login__content">
        ...
        <form action="{{route('workout',$id)}}" method="post" enctype="multipart/form-data" class="login__form">
            @csrf
                ...
                <div class="login__inputs">
                    ...
                    <div>
                        ...
                        <div class="input">
                            ...
                            <input name="height" type="number" placeholder="Enter your Height (Cm)" required class="input__password input__email" id="height">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="input">
                            ...
                            <input name="weight" type="number" placeholder="Enter your weight (Kg)" required class="input__password input__email" id="weight">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="input">
                            ...
                            <select required class="input__password input__email" name="exercise_level" id="exercise">
                    ...
                    <div>
                        ...
                        <div class="input">
                            ...
                            <input name="bodyfat" type="number" placeholder="Enter your body fat percentage (%)" required class="input__password input__email" id="fat">
                        </div>
                    </div>
